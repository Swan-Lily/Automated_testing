...
class PetFriends:
    ...
    def get_list_of_pets(self, auth_key: json, filter: str = "") -> json:
        ...
        получить список всех питомцев, либо получить список собственных питомцев"""
    ...
    def add_new_pet(self, auth_key: json, name: str, animal_type: str, age: str, pet_photo: str) -> json:
        """Метод отрпавляет на сервер данные о добавляемом питомце
    ...
    def add_photo_of_pet(self, auth_key: json, pet_id: str, pet_photo: str) -> json:
        """Метод отправляет на сервер фото к добавленному ранее питомцу.
        Возвращает статус запроса и данные питомца в формате json"""
    ...
    def get_api_key_for_invalid_user(self, email: str, password: str) -> json:
        headers = {
            'invalid_email': email,
    ...
    def add_pet_without_photo(self, auth_key: json, name: str, animal_type: str, age: str) -> json:
        """Добавление питомца без фото. Метод добавляет на сервер данные о добавляемом питомце
        и возвращает статус запроса на сервер и результат в формате json с данными добавленного питомца"""
        data = MultipartEncoder(
            fields={
                'name': name,
    ...
    def update_pet_photo(self, auth_key: json, pet_id: str, pet_photo: str) -> json:
        """Добавление фото к питомцу, созданному без фото. Метод отправляет запрос на сервер
        об обновлении фото питомца по указанному ID и возвращает статус запроса и result
